...
*/
    ...
    const videoData = {
        ...
        '12 strong': {
            image: '/images/home/12-strong.jpg',
            title: '12 Strong',
            slug: '12 Strong_Gaheza',
            rating: 7.9,
            actor:['Chris Hemsworth','Michael Shannon'],
            stars: 5,
            genres: ['Action', 'History', 'War'],
            interpreter: ['Gaheza'],
            tags: ['History', 'War', 'Drama'],
            ...
            duration: 'Filme',
            year: '2018',
            videoLink: 'https://cdn.miyagifilms.com/12%20STRONG.mp4',
            downloadLink: 'https://cdn.miyagifilms.com/download/12%20STRONG.mp4'
        },
        'sanak': {
            image: '/images/home/sanak.jpg',
            title: 'Sanak',
            slug: 'Sanak_Rocky',
            rating: 9,
            actor:['Vidyut Jammwal','Rukmini Maitra'],
            stars: 4,
            genres: ['Action',  'Drama'],
            interpreter: ['Rocky'],
            tags: ['India', 'Action', 'Drama'],
            description: 'Set in Mumbai, the story unfolds in a hospital that is under siege, where Vivaan Ahuja and his wife Anshika are trapped. Does he manage to rescue her and other hostages from the dangerous hoodlums?',
            age: '12+',
            duration: 'Filme',
            year: '2021',
            videoLink: 'https://cdn.miyagifilms.com/Sanak.mp4',
            downloadLink: 'https://cdn.miyagifilms.com/download/Sanak.mp4'
        },
        'infinite': {
            image: '/images/home/infinite.jpg',
            title: 'Infinite',
            slug: 'Infinite_Sankara',
            rating: 8.9,
            actor:['Mark Wahlberg','Chiwetel Ejiofor'],
            stars: 4.5,
            genres: ['Action', 'Sci-fi', 'Adventire'],
            interpreter: ['Sankara'],
            tags: ['Infinite', 'Adventure', 'Drama'],
        ...
        'death note': {
            ...
            title: 'Death Note',
            slug: 'Death Note_Sankara',
            rating: 8.9,
            actor:['Nat Wolff','LaKeith Stanfield'],
            stars: 4.5,
            genres: ['Fantasy', 'Crime', 'Horror'],
            interpreter: ['Sankara'],
            tags: ['Fantasy', 'Horror', 'Drama'],
        ...
        'monkey man a': {
            ...
            title: 'Monkey Man A',
            slug: 'Monkey Man_ Rocky',
            rating: 8.9,
            actor:['Dev Patel','Sikandar Kher'],
            stars: 5,
            genres: ['action','Thriller'],
            interpreter: ['Rocky'],
        ...
        'bilal new born': {
            ...
            title: 'Bilal New Born',
            slug: 'Bilal New Born_Savimbi',
            rating: 8.9,
            actor:['',''],
            stars: 5,
            genres: ['',''],
        ...
        'one piece s2 ep1': {
            ...
            title: 'One Piece S2 Ep 1',
            slug:"One-Piece-S2-Ep-1_Perfect",
            rating: 8.0,
            actor:['Iñaki Godoy','Mackenyu'],
            stars: 4.5,
        ...
        'one piece s2 ep2': {
            image: '/images/episodes/onepiece.jpg',
            title: 'One Piece S2 Ep 2',
            slug:"One-Piece-S2-Ep-2_Perfect",
            rating: 8.0,
            actor:['Iñaki Godoy','Mackenyu'],
            stars: 4.5,
            genres: ['Sci-fi', 'Fantasy', 'Adventure'],
        ...
        'one piece s2 ep3': {
            image: '/images/episodes/onepiece.jpg',
            title: 'One Piece S2 Ep 3',
            slug:"One-Piece-S2-Ep-3_Perfect",
            rating: 8.0,
            actor:['Iñaki Godoy','Mackenyu'],
            stars: 4.5,
            genres: ['Sci-fi', 'Fantasy', 'Adventure'],
        ...
        'one piece s2 ep4': {
            image: '/images/episodes/onepiece.jpg',
            title: 'One Piece S2 Ep 4',
            slug:"One-Piece-S2-Ep-4_Perfect",
            rating: 8.0,
            actor:['Iñaki Godoy','Mackenyu'],
            stars: 4.5,
            genres: ['Sci-fi', 'Fantasy', 'Adventure'],
        ...
        'one piece s2 ep5': {
            image: '/images/episodes/onepiece.jpg',
            title: 'One Piece S2 Ep 5',
            slug:"One-Piece-S2-Ep-5_Perfect",
            rating: 8.0,
            actor:['Iñaki Godoy','Mackenyu'],
            stars: 4.5,
            genres: ['Sci-fi', 'Fantasy', 'Adventure'],
        ...
        'one piece s2 ep6': {
            image: '/images/episodes/onepiece.jpg',
            title: 'One Piece S2 Ep 6',
            slug:"One-Piece-S2-Ep-6_Perfect",
            rating: 8.0,
            actor:['Iñaki Godoy','Mackenyu'],
            stars: 4.5,
            genres: ['Sci-fi', 'Fantasy', 'Adventure'],
        ...
        'one piece s2 ep7': {
            image: '/images/episodes/onepiece.jpg',
            title: 'One Piece S2 Ep 7',
            slug:"One-Piece-S2-Ep-7_Perfect",
            rating: 8.0,
            actor:['Iñaki Godoy','Mackenyu'],
            stars: 4.5,
            genres: ['Sci-fi', 'Fantasy', 'Adventure'],
        ...
        'one piece s2 ep8': {
            image: '/images/episodes/onepiece.jpg',
            title: 'One Piece S2 Ep 8',
            slug:"One-Piece-S2-Ep-8_Perfect",
            rating: 8.0,
            actor:['Iñaki Godoy','Mackenyu'],
            stars: 4.5,
            genres: ['Sci-fi', 'Fantasy', 'Adventure'],
